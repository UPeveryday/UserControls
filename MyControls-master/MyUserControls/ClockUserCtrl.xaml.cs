...
namespace MyUserControls
{
    ...
    public partial class ClockUserCtrl : UserControl
    {
        ...
        public DateTime Time
        {
            get
            {
                return (DateTime)this.GetValue(TimeProperty);//getvalue和setvalue用于设置元素的属性
            }
            set
            {
        ...
        public static readonly RoutedUICommand SpeakCommand = new RoutedUICommand("Speak", "Speak", typeof(ClockUserCtrl));//参数分别为命名的显示名称,命令的名称,命令的拥有者类型.
